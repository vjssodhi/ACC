...
class RedirectionHandler implements ListenerAggregateInterface {
	...
	public function onDispatchError(MvcEvent $event) {
		...
		if ($result instanceof Response || ! $routeMatch || ($response && ! $response instanceof Response) || ! ((ERROR_NEED_AUTHENTICATED_USER === $error && ($event->getParam ( 'exception' ) instanceof AuthenticationRequired)))) {
			return;
		}
		if (null === $url) {
